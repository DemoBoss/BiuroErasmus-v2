    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <form method="post" enctype="multipart/form-data" action="{{ url('/importInzNS') }}">
                ...
                <input type="hidden" name="stacjonarne" value="{{0}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/tworzenie_przedmiotu">
                            <label>Wprowadź Przedmiot na studia inżynierskie:</label>
    ...
    <div class="modal fade" id="myModalMagister">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/tworzenie_przedmiotu">
                        <label>Wprowadź Przedmiot na studia magisterskie:</label>
                        <div class="form-group row justify-content-center">
